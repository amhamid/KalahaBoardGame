...
public class KalahaBoardGameAcceptanceTest {
    ...
    public void moving6SeedsFromAPit() {
        ...
        Assert.assertThat("Pit 2 should be not empty pit for player 2", notEmptyPitIdentifiersForPlayer2.contains("Pit 7"), is(true));
        Assert.assertThat("Pit 2 should be not empty pit for player 2", notEmptyPitIdentifiersForPlayer2.contains("Pit 8"), is(true));
        Assert.assertThat("Pit 3 should be not empty pit for player 2", notEmptyPitIdentifiersForPlayer2.contains("Pit 9"), is(true));
        Assert.assertThat("Pit 4 should be not empty pit for player 2", notEmptyPitIdentifiersForPlayer2.contains("Pit 10"), is(true));
        Assert.assertThat("Pit 5 should be not empty pit for player 2", notEmptyPitIdentifiersForPlayer2.contains("Pit 11"), is(true));
        Assert.assertThat("Pit 6 should be not empty pit for player 2", notEmptyPitIdentifiersForPlayer2.contains("Pit 12"), is(true));
    }
